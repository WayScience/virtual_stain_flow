...
### Blocks
Blocks are the smallest units in the framework, responsible for directly processing feature map tensors.
...
### Model
The `model.py` module provides the foundational classes for defining models within the framework.
